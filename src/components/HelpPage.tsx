...
const guideSections = [
  {
    ...
    items: [
      "先在设置里创建当前学期，填好第一教学周星期一和总周数。",
      "课程可以手动新增，也可以用天津大学课表提取器导入。",
      "作息时间按每天配置，节次数、午休和休息块都可以调整。"
    ]
  },
  {
    title: "今天",
  ...
  },
  {
    ...
    items: [
      "备忘录支持文件夹、搜索、置顶、回收站和永久删除。",
      "正文可使用自动编号和待办圆圈，待办项可直接点击切换完成。",
      "误删内容先进入回收站，确认无用后再永久删除。"
    ]
  },
  {
    title: "提醒与同步",
  ...
  return (
    <section className="help-page">
      ...
      <div className="help-quick-start">
        ...
        <div>
          <strong>建议顺序</strong>
          <span>创建学期、导入或新增课程、配置作息、添加事项习惯纪念日、登录同步。</span>
        </div>
      </div>
