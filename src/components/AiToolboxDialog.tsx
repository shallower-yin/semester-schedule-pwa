import { AudioLines, BrainCircuit, Languages, Network } from "lucide-react";
...
export function AiToolboxDialog({ onOpenAssistant, onOpenTranslation, onOpenMindMap, onOpenAudioTranscription, onClose }: AiToolboxDialogProps) {
  ...
  return (
    <Modal title="AI 工具箱" onClose={onClose}>
      <div className="ai-toolbox-grid">
        ...
        <button type="button" onClick={() => open(onOpenTranslation)}><Languages /><span><strong>翻译助手</strong><small>中英快速翻译、术语约束和对照阅读</small></span></button>
