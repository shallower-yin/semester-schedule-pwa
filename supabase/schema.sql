...
create table if not exists public.anniversaries (
  ...
  lunar_year integer,
  lunar_month integer check (lunar_month is null or lunar_month between 1 and 12),
  lunar_day integer check (lunar_day is null or lunar_day between 1 and 30),
  lunar_is_leap_month boolean not null default false,
  lunar_occurrence_dates date[] not null default '{}',
